...
4）通过物联网平台和灯光设备实现灯光的智能控制，全套源码资料：80元；加调试及演示：120元；

主要实现了通过语音控制灯光颜色的变化、灯光每种颜色的占比、日出日落模式等等，底层封装为api接口，支持多种开发语言对接，采用了docker一键部署，通过物联网平台和灯光设备实现灯光的智能控制，主要实现了通过语音控制灯光颜色的变化、灯光每种颜色的占比、日出日落模式等等，底层封装为api接口，支持多种开发语言对接，比如（Java、C#、C++、Python、Go、NodeJS、C等等）。

部分介绍：https://blog.csdn.net/u014374009/article/details/108693554
